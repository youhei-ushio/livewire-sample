...
<button {{ $attributes->merge(['type' => 'button', 'class' => 'absolute right-0 bottom-3 items-center px-2 py-1 bg-transparent border-0 hover:bg-transparent focus:outline-none focus:ring-0 disabled:opacity-25 transition ease-in-out duration-150']) }}>
    @if ($status)
